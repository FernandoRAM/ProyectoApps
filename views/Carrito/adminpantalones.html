  		...
  		<div class="navbar-collapse collapse container">
	   		<ul class="nav navbar-nav navbar-left right">
		     	 <li class="hover"><a href="<?=URL?>Carrito/adminplayeras">Playeras</a></li>
		      	 ...
		      	 <li class="hover actual"><a href="<?=URL?>Carrito/adminpantalones">Pantalones</a></li>
...
<script type="text/javascript">window.addEventListener('load', acargarPantalones, true);</script>
</body>
</html>